...
##                    print(towerx, towery)
                    ...
                    #shellGroup.append(Shell(screen))
                        towerGroup.append(Tower(shellGroup, towerx, towery, enemyGroup))
                        shellNumber += 1
        ...
        if len(towerGroup) > 0:
            for i in range(len(towerGroup)):
                #print "i is ", i
                #print "What is towerGroup ", i-1, "? ", towerGroup[i-1]
                ...
                if enemyHitTower:
                    for enemy in enemyHitTower[i]:
                        ...
                        towerGroup.pop(i-1)
                        #towerGroup[i].destroyed = True
                        #towerGroup[i].rect.center = (-100, -100)
                        #tower.destroyed(towerGroup)
                        #print "Tower Group Size: ", len(towerGroup)
                        #print towerGroup
                        break
            #if enemyHitTower or towerGroup[i].destroyed == False:
            #    towerGroup[i].destroyed = True
            #    print "Chris it touched me!"
