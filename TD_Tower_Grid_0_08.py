...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, path):
        ...
        #print map(operator.sub, self.path[1], self.path[0])
        #self.reset()
...
def main():
    ...
    shellGroup = []
    enemyGroup = []
    #print roadGroup[0].Road.roadx, roadGroup[1]
    #enemy = Enemy(pathGroup)
